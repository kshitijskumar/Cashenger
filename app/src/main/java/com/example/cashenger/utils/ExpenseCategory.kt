...
sealed class ExpenseCategory(val categoryId: Int, @DrawableRes val categoryIconRes: Int? = null, val bgColor: Color) {
    ...
    object Gift : ExpenseCategory(categoryId = 1, categoryIconRes = R.drawable.ic_gift, Orange)
    object Petrol : ExpenseCategory(categoryId = 1, categoryIconRes = R.drawable.ic_petrol, Color.Red)
    object Salary : ExpenseCategory(categoryId = 1, categoryIconRes = R.drawable.ic_money_sack, Green)
    object Travel : ExpenseCategory(categoryId = 1, categoryIconRes = R.drawable.ic_travel, Blue)
    object Education : ExpenseCategory(categoryId = 1, categoryIconRes = R.drawable.ic_education, Magenta)
}
